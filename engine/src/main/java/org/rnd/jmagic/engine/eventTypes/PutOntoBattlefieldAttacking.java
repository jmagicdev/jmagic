...
public final class PutOntoBattlefieldAttacking extends EventType
{
	public static final EventType INSTANCE = new PutOntoBattlefieldAttacking();

	private PutOntoBattlefieldAttacking()
	{
		super("PUT_ONTO_BATTLEFIELD_ATTACKING");
	}
