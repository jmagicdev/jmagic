...
public enum SubType
{
	...
	// Weird stuff
	ARCHON(Category.CREATURE), AVATAR(Category.CREATURE), CARRIER(Category.CREATURE), CONSTRUCT(Category.CREATURE), COWARD(Category.CREATURE), DESERTER(Category.CREATURE), GERM(Category.CREATURE), GOD(Category.CREATURE), INCARNATION(Category.CREATURE), JUGGERNAUT(Category.CREATURE), ORB(Category.CREATURE), PENTAVITE(Category.CREATURE), PEST(Category.CREATURE), PINCHER(Category.CREATURE), PRAETOR(Category.CREATURE), PRISM(Category.CREATURE), REFLECTION(Category.CREATURE), SAND(Category.CREATURE), SPAWN(Category.CREATURE), SPLINTER(Category.CREATURE), SPONGE(Category.CREATURE), TETRAVITE(Category.CREATURE), THOPTER(Category.CREATURE), TRISKELAVITE(Category.CREATURE), WEIRD(Category.CREATURE), WEREWOLF(Category.CREATURE),

	// ***Planeswalker Types***
	AJANI(Category.PLANESWALKER), //
	ASHIOK(Category.PLANESWALKER), //
	BOLAS(Category.PLANESWALKER), //
	CHANDRA(Category.PLANESWALKER), //
	DACK(Category.PLANESWALKER), //
	...
	KIORA(Category.PLANESWALKER), //
	RAL(Category.PLANESWALKER), //
