...
public class Start
{
	...
	static
	{
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.BLOCK.getName());
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.STANDARD.getName());
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.EXTENDED.getName());
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.MODERN.getName());
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.LEGACY.getName());
		FORMAT_STRINGS.add(org.rnd.jmagic.engine.GameType.VINTAGE.getName());
	}
	...
	private Start()
	{
		...
		for(org.rnd.jmagic.engine.GameType gameType: org.rnd.jmagic.engine.GameType.values())
					...
					java.awt.EventQueue.invokeLater(new Runnable()
					{
						...
						public void run()
						{
							if(null == Start.this.gameTypeDialog)
							{
								...
								for(org.rnd.jmagic.engine.GameType t: org.rnd.jmagic.engine.GameType.values())
									presets.add(t);
