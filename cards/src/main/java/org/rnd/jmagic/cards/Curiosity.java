...
@ManaCost("U")
@Printings({@Printings.Printed(ex = Innistrad.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = EighthEdition.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = Exodus.class, r = Rarity.UNCOMMON)})
