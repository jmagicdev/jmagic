...
@Printings({@Printings.Printed(ex = NinthEdition.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = EighthEdition.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = FifthEdition.class, r = Rarity.COMMON), @Printings.Printed(ex = Antiquities.class, r = Rarity.UNCOMMON)})
@ColorIdentity({})
public final class UrzasPowerPlant extends Card
{
	public static final class MakeMana extends ActivatedAbility
	{
		public MakeMana(GameState state)
		{
			...
			SetGenerator mana = IfThenElse.instance(Both.instance(youControlMine, youControlTower), Identity.fromCollection(new ManaPool("2")), Identity.fromCollection(new ManaPool("1")));
