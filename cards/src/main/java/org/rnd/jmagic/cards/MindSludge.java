...
@Types({Type.SORCERY})
@ManaCost("4B")
@Printings({@Printings.Printed(ex = Zendikar.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = EighthEdition.class, r = Rarity.UNCOMMON), @Printings.Printed(ex = Torment.class, r = Rarity.UNCOMMON)})
